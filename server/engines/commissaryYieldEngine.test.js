...
//
// getCommissaryBalance/listCommissaryBalances - RETIRED 2026-08-30
// (Round 2 findings, item 5: a real live bug where this older,
// lifetime-cumulative, no-New-Stock-concept calculation disagreed with
// commissaryAuditEngine.js's newer, correct daily audit). Both
// functions and their whole test block (backed-in vs. shipped-out,
// DIRECT-receipt exclusion, soft-delete exclusion, zero-activity case,
// list-matches-individual-lookup) removed together - historical
// context on the balance formula itself stays in
// docs/commissary-and-stock-receipts.md, not duplicated here.
