...
## Archived 2026-09-02 — step 24 design narrative and completed sub-steps

Moved out of `session-status.md` per rule 22 (the file had reached 573 lines).
Everything below is finished or superseded; the decisions it produced are in
`session-status.md`'s "Things NOT to re-litigate" section.
